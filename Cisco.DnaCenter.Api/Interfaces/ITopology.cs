...
namespace Cisco.DnaCenter.Api.Interfaces
{
	...
	public interface ITopology
	{
		...
		System.Threading.Tasks.Task<TopologyResult> GetL3TopologyDetails([Header("UserAgent")] string userAgent, [AliasAs("topologyType")]string topologyType);
		...
		System.Threading.Tasks.Task<GetOverallNetworkHealthResponse> GetOverallNetworkHealth([Header("UserAgent")] string userAgent, [AliasAs("timestamp")]string timestamp = null);
		...
		System.Threading.Tasks.Task<TopologyResult> GetPhysicalTopology([Header("UserAgent")] string userAgent, [AliasAs("nodeType")]string nodeType = null);
		...
		System.Threading.Tasks.Task<SiteResult> GetSiteTopology([Header("UserAgent")] string userAgent);
		...
		System.Threading.Tasks.Task<TopologyResult> GetTopologyDetails([Header("UserAgent")] string userAgent, [AliasAs("vlanID")]string vlanID);
		...
		System.Threading.Tasks.Task<VlanNamesResult> GetVLANDetails([Header("UserAgent")] string userAgent);
