...
namespace Cisco.DnaCenter.Api.Data
{
	...
	/// </summary>
	[DataContract]
	public partial class CreateWirelessProfileResponse
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="CreateWirelessProfileResponse" /> class.
		/// </summary>
		/// <param name="ExecutionId">ExecutionId.</param>
		/// <param name="ExecutionStatusUrl">ExecutionStatusUrl.</param>
		/// <param name="Message">Message.</param>
		public CreateWirelessProfileResponse(string? ExecutionId = default, string? ExecutionStatusUrl = default, string? Message = default)
		{
		...
		public override string ToString()
		{
			...
			sb.Append("class CreateWirelessProfileResponse {\n");
