...
namespace Cisco.DnaCenter.Api.Data
{
	...
	public class AddVirtualAccountResponse
	{
		...
		public AddVirtualAccountResponse(string? VirtualAccountId = default, decimal? AutoSyncPeriod = default, string? SyncResultStr = default, GetSyncResultForVirtualAccountResponseProfile Profile = default, string? CcoUser = default, GetSyncResultForVirtualAccountResponseSyncResult SyncResult = default, string? Token = default, decimal? SyncStartTime = default, decimal? LastSync = default, string? TenantId = default, string? SmartAccountId = default, decimal? Expiry = default, string? SyncStatus = default)
		{
		...
		public override string ToString()
		{
			...
			sb.Append("class AddVirtualAccountResponse {\n");
