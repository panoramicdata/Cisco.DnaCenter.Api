...
namespace Cisco.DnaCenter.Api.Data
{
	...
	public class AssignCredentialToSiteResponse
	{
		...
		public AssignCredentialToSiteResponse(string? ExecutionId = default, string? ExecutionStatusUrl = default, string? Message = default)
		{
		...
		public override string ToString()
		{
			...
			sb.Append("class AssignCredentialToSiteResponse {\n");
