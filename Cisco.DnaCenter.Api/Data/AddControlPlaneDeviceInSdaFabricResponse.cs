...
namespace Cisco.DnaCenter.Api.Data
{
	...
	/// </summary>
	[DataContract]
	public class AddControlPlaneDeviceInSdaFabricResponse
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="AddControlPlaneDeviceInSdaFabricResponse" /> class.
		/// </summary>
		/// <param name="Status">Status.</param>
		/// <param name="Description">Description.</param>
		/// <param name="ExecutionStatusUrl">ExecutionStatusUrl.</param>
		public AddControlPlaneDeviceInSdaFabricResponse(string? Status = default, string? Description = default, string? ExecutionStatusUrl = default)
		{
			this.Status = Status;
