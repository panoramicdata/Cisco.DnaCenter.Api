...
namespace Cisco.DnaCenter.Api.Data
{
	...
	/// </summary>
	[DataContract]
	public partial class CreateSiteResponse
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="CreateSiteResponse" /> class.
		/// </summary>
		/// <param name="ExecutionId">ExecutionId.</param>
		/// <param name="ExecutionStatusUrl">ExecutionStatusUrl.</param>
		/// <param name="Message">Message.</param>
		public CreateSiteResponse(string? ExecutionId = default, string? ExecutionStatusUrl = default, string? Message = default)
		{
