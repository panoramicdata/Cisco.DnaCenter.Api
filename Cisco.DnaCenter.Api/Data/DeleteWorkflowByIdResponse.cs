...
namespace Cisco.DnaCenter.Api.Data
{
	...
	public class DeleteWorkflowByIdResponse
	{
		...
		public override string ToString()
		{
			...
			sb.Append("class DeleteWorkflowByIdResponse {\n");
