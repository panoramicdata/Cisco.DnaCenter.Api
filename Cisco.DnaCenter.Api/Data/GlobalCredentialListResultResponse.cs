...
public class GlobalCredentialListResultResponse
{
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="GlobalCredentialListResultResponse" /> class.
	/// </summary>
	...
	public GlobalCredentialListResultResponse(string? Comments = default, CredentialTypeEnum? CredentialType = default, string? Description = default, string? Id = default, string? InstanceTenantId = default, string? InstanceUuid = default)
	{
