...
namespace Cisco.DnaCenter.Api.Data
{
	...
	/// </summary>
	[DataContract]
	public partial class SyncVirtualAccountDevicesResponse
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="SyncVirtualAccountDevicesResponse" /> class.
		/// </summary>
		...
		public SyncVirtualAccountDevicesResponse(string? VirtualAccountId = default, decimal? AutoSyncPeriod = default, string? SyncResultStr = default, GetSyncResultForVirtualAccountResponseProfile Profile = default, string? CcoUser = default, GetSyncResultForVirtualAccountResponseSyncResult SyncResult = default, string? Token = default, decimal? SyncStartTime = default, decimal? LastSync = default, string? TenantId = default, string? SmartAccountId = default, decimal? Expiry = default, string? SyncStatus = default)
		{
		...
		public override string ToString()
		{
			...
			sb.Append("class SyncVirtualAccountDevicesResponse {\n");
