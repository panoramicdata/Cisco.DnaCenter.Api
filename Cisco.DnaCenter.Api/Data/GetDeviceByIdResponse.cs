...
namespace Cisco.DnaCenter.Api.Data
{
	...
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="GetDeviceByIdResponse" /> class.
		/// </summary>
		...
		public override string ToString()
		{
			...
			sb.Append("class GetDeviceByIdResponse {\n");
