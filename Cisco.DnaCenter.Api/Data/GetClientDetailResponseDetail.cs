...
{
	/// <summary>
	/// GetClientDetailResponseDetail
	/// </summary>
	[DataContract]
	public partial class GetClientDetailResponseDetail
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="GetClientDetailResponseDetail" /> class.
		/// </summary>
		...
		public override string ToString()
		{
			...
			sb.Append("class GetClientDetailResponseDetail {\n");
			...
			sb.Append("  IosCapable: ").Append(IosCapable).Append("\n");
			sb.Append("}\n");
			return sb.ToString();
		}
	}
