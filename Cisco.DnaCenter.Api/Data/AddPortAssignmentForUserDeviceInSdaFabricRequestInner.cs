...
/// </summary>
[DataContract]
public class AddPortAssignmentForUserDeviceInSdaFabricRequestInner
{
	/// <summary>
	/// Initializes a new instance of the <see cref="AddPortAssignmentForUserDeviceInSdaFabricRequestInner" /> class.
	/// </summary>
	...
	public AddPortAssignmentForUserDeviceInSdaFabricRequestInner(string? SiteNameHierarchy = default, string? DeviceManagementIpAddress = default, string? InterfaceName = default, string? DataIpAddressPoolName = default, string? VoiceIpAddressPoolName = default, string? AuthenticateTemplateName = default)
	{
