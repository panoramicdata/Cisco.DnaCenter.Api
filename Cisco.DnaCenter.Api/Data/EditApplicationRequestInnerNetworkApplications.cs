...
{
	/// <summary>
	/// EditApplicationRequestInnerNetworkApplications
	/// </summary>
	[DataContract]
	public partial class EditApplicationRequestInnerNetworkApplications
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="EditApplicationRequestInnerNetworkApplications" /> class.
		/// </summary>
		...
		public EditApplicationRequestInnerNetworkApplications(string? Id = default, string? AppProtocol = default, string? ApplicationSubType = default, string? ApplicationType = default, string? CategoryId = default, string? DisplayName = default, string? EngineId = default, string? HelpString = default, string? LongDescription = default, string? Name = default, string? Popularity = default, string? Rank = default, string? TrafficClass = default, string? ServerName = default, string? Url = default, string? Dscp = default, string? IgnoreConflict = default)
		{
			this.Id = Id;
		...
		public override string ToString()
		{
			...
			sb.Append("class EditApplicationRequestInnerNetworkApplications {\n");
