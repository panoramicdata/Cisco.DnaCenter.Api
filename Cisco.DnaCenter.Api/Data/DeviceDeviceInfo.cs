...
namespace Cisco.DnaCenter.Api.Data
{
	...
	public class DeviceDeviceInfo
	{
		...
		public DeviceDeviceInfo(string? Source = default, string? SerialNumber = default, bool? Stack = default, string? Mode = default, string? State = default, DeviceDeviceInfoLocation Location = default, string? Description = default, string? OnbState = default, string? AuthenticatedMicNumber = default, string? AuthenticatedSudiSerialNo = default, List<string> CapabilitiesSupported = default, List<string> FeaturesSupported = default, string? CmState = default, decimal? FirstContact = default, decimal? LastContact = default, string? MacAddress = default, string? Pid = default, List<string> DeviceSudiSerialNos = default, decimal? LastUpdateOn = default, string? WorkflowId = default, string? WorkflowName = default, string? ProjectId = default, string? ProjectName = default, string? DeviceType = default, string? AgentType = default, string? ImageVersion = default, List<DeviceDeviceInfoFileSystemList> FileSystemList = default, List<DeviceDeviceInfoPnpProfileList> PnpProfileList = default, string? ImageFile = default, List<DeviceDeviceInfoHttpHeaders> HttpHeaders = default, List<DeviceDeviceInfoNeighborLinks> NeighborLinks = default, decimal? LastSyncTime = default, List<DeviceDeviceInfoIpInterfaces> IpInterfaces = default, string? Hostname = default, string? AuthStatus = default, DeviceDeviceInfoStackInfo StackInfo = default, bool? ReloadRequested = default, decimal? AddedOn = default, string? SiteId = default, DeviceDeviceInfoAaaCredentials AaaCredentials = default, List<string> UserMicNumbers = default, List<string> UserSudiSerialNos = default, List<string> AddnMacAddrs = default, List<DeviceDeviceInfoPreWorkflowCliOuputs> PreWorkflowCliOuputs = default, Object Tags = default, bool? SudiRequired = default, string? SmartAccountId = default, string? VirtualAccountId = default, bool? PopulateInventory = default, string? SiteName = default, string? Name = default)
		{
			this.Source = Source;
