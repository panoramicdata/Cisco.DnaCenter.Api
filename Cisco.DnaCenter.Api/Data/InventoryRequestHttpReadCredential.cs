...
namespace Cisco.DnaCenter.Api.Data
{
	...
	public class InventoryRequestHttpReadCredential
	{
		...
		public InventoryRequestHttpReadCredential(string? Comments = default, CredentialTypeEnum? CredentialType = default, string? Description = default, string? Id = default, string? InstanceTenantId = default, string? InstanceUuid = default, string? Password = default, int? Port = default, bool? Secure = default, string? Username = default)
		{
		...
		public override string ToString()
		{
			...
			sb.Append("class InventoryRequestHttpReadCredential {\n");
