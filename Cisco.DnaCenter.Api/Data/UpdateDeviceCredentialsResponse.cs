...
namespace Cisco.DnaCenter.Api.Data
{
	...
	/// </summary>
	[DataContract]
	public partial class UpdateDeviceCredentialsResponse
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="UpdateDeviceCredentialsResponse" /> class.
		/// </summary>
		/// <param name="ExecutionId">ExecutionId.</param>
		/// <param name="ExecutionStatusUrl">ExecutionStatusUrl.</param>
		/// <param name="Message">Message.</param>
		public UpdateDeviceCredentialsResponse(string? ExecutionId = default, string? ExecutionStatusUrl = default, string? Message = default)
		{
		...
		public override string ToString()
		{
			...
			sb.Append("class UpdateDeviceCredentialsResponse {\n");
